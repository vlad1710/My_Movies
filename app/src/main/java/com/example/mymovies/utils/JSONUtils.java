    ...
    public static ArrayList<Movie> getMoviesFromJSON (JSONObject jsonObject){
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++){
                ...
                int voteCpunt = objectMovie.getInt(KEY_VOTE_COUNT);
                ...
                double voteAvarage = objectMovie.getDouble(KEY_VOTE_AVERAGE);
                String releaseDate = objectMovie.getString(KEY_RELEASE_DATE);

                Movie movie = new Movie(id, voteCpunt, title, originalTitle, overview, posterPath, bigPosterPath, backdropPath, voteAvarage, releaseDate);
                result.add(movie);

...
public class NetworkUtils {
    ...
    private static final String BASE_SORT_BY = "sort_by";
    private static final String BASE_PAGE = "page";
    private static final String PARAMS_MIN_VOTE_COUNT = "vote_count.gte";

    private static final String API_KEY = "7a595c901f4d784d4aff94e2cc4430a2";
    ...
    public static URL buildURL(int sortBy, int page, String lang){
        ...
        Uri uri = Uri.parse(BASE_URL).buildUpon()
                ...
                .appendQueryParameter(BASE_SORT_BY, methodOfSort)
                .appendQueryParameter(BASE_PAGE, Integer.toString(page))
                .build();
